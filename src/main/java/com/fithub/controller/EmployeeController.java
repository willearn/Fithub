...
public class EmployeeController {
	...
	// .put("employeename", emp.getEmployeename()).put("employeeemail",
	// emp.getEmployeeemail())
	// .put("employeephone", emp.getEmployeephone()).put("employeegender",
	// emp.getEmployeegender())
	// .put("employeecity", emp.getEmployeecity()).put("employeezone",
	// emp.getEmployeezone())
	// .put("employeeaddress", emp.getEmployeeaddress()).put("deptid",
	// emp.getDeptid())
	// .put("deptname", emp.getDepartment().getDeptname()).put("jobtitleid",
	// emp.getJobtitleid())
	// .put("jobtitlename", emp.getJobtitle().getJobtitlename()).put("managerid",
	// emp.getManagerid())
	// .put("hiredate", emp.getHiredate()).put("resigndate", emp.getResigndate())
	// .put("salary", emp.getSalary()).put("employeebirthday",
	// emp.getEmployeebirthday())
