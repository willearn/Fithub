...
//		System.out.println("resultBeans--------------------" + resultBeans);
	...
	@GetMapping("/employees/findClassesInDateRangeAndEmployeeid")
	public ResponseEntity<?> findClassesInDateRangeAndEmployeeid(@RequestParam(value = "employeeid") int employeeid,
			@RequestParam(value = "classDate") String classDate, @RequestParam(value = "classTime") String classTime) {
		try {
			List<Map<String, Object>> resultList = eService.findClassesInDateRangeAndEmployeeid(employeeid, classDate,
					classTime);
			if (resultList != null) {
